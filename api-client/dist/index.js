...
var api = {
    ...
    createUser: function createUser(name, surname, email, username, password) {
        return this._call('post', 'user', { name: name, surname: surname, email: email, password: password });
    },
    ...
    updateRecipe: function updateRecipe(title, category, image, video, ingredients, elaboration, dificulty, preparation, region, seasson, observation, token) {
        return this._call('put', 'recipe', { title: title, category: category, image: image, video: video, ingredients: ingredients, elaboration: elaboration, dificulty: dificulty, preparation: preparation, region: region, seasson: seasson, observation: observation }, token);
    },
